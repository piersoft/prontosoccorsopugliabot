 ...
 if(iframe){
    ...
    iframe.height = altezza+"px";
      ...
      <div id="loadImg"><div><img src="ajax-loader3.gif" /></div></div>
         <iframe id="mioIFRAME" border=0 name=iframe src="test.php?id=<?php printf($_GET['id']); ?>" width="100%" scrolling="no" frameborder="0" onload="document.getElementById('loadImg').style.display='none';"></iframe>
       </body>
       </html>
